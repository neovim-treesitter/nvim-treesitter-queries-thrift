# nvim-treesitter-queries-thrift

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-thrift/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-thrift/actions/workflows/validate.yml)

Neovim tree-sitter queries for **thrift**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-thrift",
...
- [ ] Changes are scoped to `thrift` — do not include files for other languages
